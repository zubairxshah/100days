...
let userG1 :string[] = ['martrin', 'Harold', 'Windy', 'Patrick'];
let userG2 :string[] = ['Martrin', 'betty', 'windy', 'James'];
...
let current_users: string[] = ["Martin", "Harold", "Windy", "Patrick"];
let new_users: string[] = ["martin", "betty", "Windy", "James"];
